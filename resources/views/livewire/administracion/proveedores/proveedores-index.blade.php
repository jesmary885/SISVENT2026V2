        ...
        <div class="bg-white rounded-2xl shadow-xl p-6 border border-gray-200">
            <div class="flex flex-col lg:flex-row gap-4 items-center">
                ...
                <div class="w-full lg:w-auto">
                    @livewire('administracion.proveedores.proveedores-create', ['tipo' => 'agregar'])
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <h2 class="text-xl font-bold text-white">Proveedores Registrados</h2>
                        </div>
                        <span class="bg-white text-blue-600 px-3 py-1 rounded-full text-sm font-bold">
                            {{ $registros->count() }} proveedores
                        </span>
                    </div>
                </div>
                    ...
                    <table class="w-full">
                        <thead class="bg-gray-50 border-b border-gray-200">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-center font-semibold text-gray-700">Nombre del proveedor</th>
                                <th class="px-6 py-4 text-center font-semibold text-gray-700">Nro de teléfono</th>
                            ...
                            <tr class="hover:bg-blue-50 transition-colors duration-200 group">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex justify-center space-x-2">
                                        ...
                                        @livewire('administracion.proveedores.proveedores-create', ['registro' => $registro,'tipo' => 'editar'], key('edit-'.$registro->id))
    ...
    <!-- Estado vacío mejorado -->
        <div class="max-w-2xl mx-auto">
            <div class="bg-white rounded-2xl shadow-xl p-12 text-center border border-gray-200">
                ...
                <p class="text-gray-600 mb-6 text-lg">No hay proveedores registrados en el sistema. Comienza agregando tu primer proveedor.</p>
